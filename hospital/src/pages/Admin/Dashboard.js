...
import { FiCalendar, FiLoader, FiTrendingUp } from 'react-icons/fi'
    ...
    <div className='dashboard_container'>
        ...
        <div className='dashboard_body' >
            ...
            <div style={{width:'100%', display:'flex', alignItems:'center'}}>
                ...
                <div className='dashboard_body_header_displays' style={{cursor:'pointer'}} onClick={()=>window.location.reload()} >
                    <div className='dashboard_body_header_displays_icon'>
                        <FiCalendar size={25} color="#0463ca" />
                    </div>

                    <Link to='/patient_stats' className='dashboard_body_header_displays_text'>
                        <h1>Patient Statistics Dashboard</h1>
                    </Link>
                </div>
            </div>
