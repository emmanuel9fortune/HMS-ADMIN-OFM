...
function PatientDetails({handleBack, currentIndex, setcurrentIndex}) {
    ...
    useEffect(()=>{
        const func=async()=>{
            try {
                await axios.post(`http://${'localhost'}:7700/getPatientDetails`, {uid: id?.id}).then((res)=>{
                    //console.log(res);
    ...
    //     try {
    //         await axios.post(`http://${'localhost'}:7700/editPatientDetails`, {changes: changes, uid: id?.id}).then((res)=>{
    //             if(res.data.status === 'success'){
    //                 setreload(reload + 1)
    ...
    //     if (opId) {
    //     try {
    //         await axios.post(`http://${'localhost'}:7700/deleteTable`, { opId, uid });
    //     } catch (error) {
    //         console.error(error);
    //     }
    //     }
    ...
    //     try {
    //     const res = await axios.post(`http://${'localhost'}:7700/operations`, {
    //         formFields: formData,
    //         uid
    //     });
    ...
    //     if (_id) {
    //     try {
    //         await axios.post(`http://${'localhost'}:7700/deleteTable`, { uid, Id: _id });
    //     } catch (error) {
    //         console.log(error);
    //     }
    //     }
    ...
    //     try {
    //     await axios.post(`http://${'localhost'}:7700/antenatal7`, {
    //         uid,
                ...
                <div className='dashboard_body' >
                    ...
                    
                    {
                        ...
                        <>
                            ...
                            <div className='patient_details_input_field1' >
                                <div className='patient_details_input_field1_' >
                                    <h4>PATIENT NAME</h4>
                                    <input disabled placeholder='Enter Patient Name' value={name} onChange={(e)=>setname(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>CENTER</h4>
                                    <input disabled placeholder='Enter center' value={center} onChange={(e)=>setcenter(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>SPECIAL POINTS</h4>
                                    <input disabled placeholder='Enter special Point' value={specialPoints} onChange={(e)=>setspecialPoints(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>ADDRESS</h4>
                                    <input disabled value={address} onChange={(e)=>setaddress(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_'>
                                    <h4>RELIGION</h4>
                                    <p>{religion}</p>
                                ...
                                <div className='patient_details_input_field1_' >
                                    <h4>SECT</h4>
                                    <input disabled value={sect} onChange={(e)=>setsect(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>DATE OF BIRTH</h4>
                                    <input disabled type='date' value={dateOfBirth} onChange={(e)=>setdateOfBirth(e.target.value)} />
                                </div>
                                
                                <div className='patient_details_input_field1_in_'>
                                    <div className='patient_details_input_field1_in' >
                                        <h4>AGE</h4>
                                        <input disabled type='number' value={age} onChange={(e)=>setage(e.target.value)} />
                                    </div>
                                    <div className='patient_details_input_field1_in' >
                                        <h4>TRIBE</h4>
                                        <input disabled value={tribe} onChange={(e)=>settribe(e.target.value)} />
                                    </div>
                                </div>

                                <div className='patient_details_input_field1_' >
                                    <h4>SPOUSE PHONE NUMBER</h4>
                                    <input disabled type='number' value={spousePhone} onChange={(e)=>setspousePhone(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>NEXT OF KIN</h4>
                                    <input disabled value={nextOfKin} onChange={(e)=>setnextOfKin(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>NEXT OF KIN'S PHONE</h4>
                                    <input disabled value={nextOfKinPhone} onChange={(e)=>setnextOfKinPhone(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div className='patient_details_input_field1'>
                                <div className='patient_details_input_field1_' >
                                    ...
                                    <input disabled value={nextOfKinAddress} onChange={(e)=>setnextOfKinAddress(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>DATE OF BOOKING</h4>
                                    <input disabled type='date' value={dateOfBooking} onChange={(e)=>setdateOfBooking(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>OCCUPATION</h4>
                                    <input disabled value={occupation} onChange={(e)=>setoccupation(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>LEVEL OF EDUCATION</h4>
                                    <input disabled value={educationLevel} onChange={(e)=>seteducationLevel(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>MARITA STATUS</h4>
                                    <p>{maritalStatus}</p>
                                ...
                                <div className='patient_details_input_field1_' >
                                    ...
                                    <input disabled value={ageAtMarriage} onChange={(e)=>setageAtMarriage(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>L.M.P</h4>
                                    <input disabled value={LMP} onChange={(e)=>setLMP(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>EDD BY USS</h4>
                                    <input disabled value={eddByUss} onChange={(e)=>seteddByUss(e.target.value)} />
                                </div>

                                <div className='patient_details_input_field1_' >
                                    <h4>EDD DATE</h4>
                                    <input disabled value={eddDate} onChange={(e)=>seteddDate(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>AVERAGE MONTHLY FAMILY INCOME</h4>
                                    <input disabled value={AverageMonthlyFamilyIncome} onChange={(e)=>setAverageMonthlyFamilyIncome(e.target.value)} />
                                </div>
                            </div>
                        </div>
                        {/* //////////////////////////////////////////////////////////////////////// */}
                        ...
                        <div className='previouse_medicals_checkbox' >
                            <div className='previouse_medicals_checkbox_text'>
                                ...
                                <div>
                                    <div>
                                        <p>Yes</p>
                                        <input disabled checked={heartDisease === 'yes' ? true : false} onChange={(e)=> setheartDisease('yes')} type='checkbox' />
                                    </div>
                                    
                                    <div>
                                        <p>No</p>
                                        <input disabled checked={heartDisease === 'no' ? true : false} onChange={(e)=> setheartDisease('no')} type='checkbox' />
                                    </div>
                                </div>
                            </div>
                            <div className='previouse_medicals_checkbox_text'>
                                ...
                                <div>
                                    <div>
                                        <p>Yes</p>
                                        <input disabled checked={kidneyDisease === 'yes' ? true : false} onChange={(e)=> setkidneyDisease('yes')} type='checkbox' />
                                    </div>
                                    
                                    <div>
                                        <p>No</p>
                                        <input disabled type='checkbox' checked={kidneyDisease === 'no' ? true : false} onChange={(e)=> setkidneyDisease('no')} />
                                    </div>
                                </div>
                            </div>
                            <div className='previouse_medicals_checkbox_text'>
                                ...
                                <div>
                                    <div>
                                        <p>Yes</p>
                                        <input disabled checked={Diabetes === 'yes' ? true : false} onChange={(e)=> setDiabetes('yes')} type='checkbox' />
                                    </div>
                                    
                                    <div>
                                        <p>No</p>
                                        <input disabled checked={Diabetes === 'no' ? true : false} onChange={(e)=> setDiabetes('no')} type='checkbox' />
                                    </div>
                                </div>
                            </div>
                            <div className='previouse_medicals_checkbox_text'>
                                ...
                                <div>
                                    <div>
                                        <p>Yes</p>
                                        <input disabled checked={ChestDisease === 'yes' ? true : false} onChange={(e)=> setChestDisease('yes')} type='checkbox' />
                                    </div>
                                    
                                    <div>
                                        <p>No</p>
                                        <input disabled checked={ChestDisease === 'no' ? true : false} onChange={(e)=> setChestDisease('no')} type='checkbox' />
                                    </div>
                                </div>
                            </div>
                            <div className='previouse_medicals_checkbox_text'>
                                ...
                                <div>
                                    <div>
                                        <p>Yes</p>
                                        <input disabled checked={Covid === 'yes' ? true : false} onChange={(e)=> setCovid('yes')} type='checkbox' />
                                    </div>
                                    
                                    <div>
                                        <p>No</p>
                                        <input disabled checked={Covid === 'no' ? true : false} onChange={(e)=> setCovid('no')} type='checkbox' />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='patient_details_input_field1_operations'>
                            <div className='patient_details_input_field1_' >
                                <h4>OPERATIONS</h4>
                                <input disabled value={NumberOfOperations} onChange={(e)=>setNumberOfOperations(e.target.value)} />
                            </div>
                            <div className='patient_details_input_field1_' >
                                <h4>PREVIOUS PREGNANCIES TOTAL</h4>
                                <input disabled value={PreviousePregnancies} onChange={(e)=>setPreviousePregnancies(e.target.value)} />
                            </div>
                            <div className='patient_details_input_field1_' >
                                <h4>NO. OF LIVING CHILDREN</h4>
                                <input disabled value={NoOfLivingChildren} onChange={(e)=>setNoOfLivingChildren(e.target.value)} />
                            </div>
                        </div>
                        {/* //////////////////////////////////////////////////////////////////////// */}
                        {/* ------------------------------------------------------------------------ */}
                        ...
                        <table className='custome_table'>
                            ...
                            <tbody>
                            {
                                ...
                                <tr key={index}>
                                <td><input disabled name='dateOfBirth' value={row.dateOfBirth} onChange={(e) => handleChange(index, e)} type='date' /></td>
                                <td><input disabled name='durationOfPregnancy' value={row.durationOfPregnancy} onChange={(e) => handleChange(index, e)} placeholder='details' /></td>
                                <td><input disabled name='birthWeight' value={row.birthWeight} onChange={(e) => handleChange(index, e)} placeholder='details' /></td>
                                <td><input disabled name='complicationInPregnancy' value={row.complicationInPregnancy} onChange={(e) => handleChange(index, e)} placeholder='details' /></td>
                                <td><input disabled name='complicationIInLabour' value={row.complicationIInLabour} onChange={(e) => handleChange(index, e)} placeholder='details' /></td>
                                <td><input disabled name='puerPremium' value={row.puerPremium} onChange={(e) => handleChange(index, e)} placeholder='details' /></td>
                                <td><input disabled name='ageAtDeath' value={row.ageAtDeath} onChange={(e) => handleChange(index, e)} placeholder='details' /></td>
                                <td><input disabled name='causeOfDeath' value={row.causeOfDeath} onChange={(e) => handleChange(index, e)} placeholder='details' /></td>
                                </tr>
                            ))}
                            </tbody>
                        </table>
                        ...
                        <div className='previouse_medicals_textareas' >
                            <div className='patient_details_input_field1' >
                                <div className='patient_details_input_field1_'>
                                    ...
                                    <textarea disabled value={letter} onChange={(e)=>setletter(e.target.value)} />
                                </div>
                            </div>
                            <div className='patient_details_input_field1' >
                                <div className='patient_details_input_field1_'>
                                    <h4>ATTACH REPORT OF SPECIAL INVESTIGATION HERE</h4>
                                    <textarea disabled value={specialInvestigation} onChange={(e)=>setspecialInvestigation(e.target.value)} />
                                </div>
                            </div>
                        </div>
                        {/* //////////////////////////////////////////////////////////////////////// */}
                        ...
                        <div className='patient_details_' >
                            ...
                            <div className='patient_details_input_field1_' >
                                ...
                                <input disabled value={historyPreg} onChange={(e)=>sethistoryPreg(e.target.value)} />
                            </div>
                            <div className='patient_details_input_field1_' >
                                <h4>URINARY SYMPTOMS</h4>
                                <input disabled value={urinarySymptoms} onChange={(e)=>seturinarySymptoms(e.target.value)} />
                            </div>
                            <div className='patient_details_input_field1_' >
                                <h4>VOMITING</h4>
                                <input disabled value={vomiting} onChange={(e)=>setvomiting(e.target.value)} />
                            </div>
                            <div className='patient_details_input_field1_' > 
                                <h4>VAGINAL DISCHARGE</h4>
                                <input disabled value={vaginalDischarge} onChange={(e)=>setvaginalDischarge(e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className='patient_details_input_field1'>
                            <div className='patient_details_input_field1_' >
                                ...
                                <input disabled value={swellingOfAnkles} onChange={(e)=>setswellingOfAnkles(e.target.value)} />
                            </div>
                            <div className='patient_details_input_field1_' >
                                <h4>BLEEDING</h4>
                                <input disabled value={bleeding} onChange={(e)=>setbleeding(e.target.value)} />
                            </div>
                            <div className='patient_details_input_field1_' >
                                <h4>OTHER SYMPTOMS</h4>
                                <input disabled value={otherSymptoms} onChange={(e)=>setotherSymptoms(e.target.value)} />
                            </div>
                        </div>
                        </div>
                        {/* //////////////////////////////////////////////////////////////////////// */}
                        ...
                        <div className='patient_details_' >
                            <div className='patient_details_input_field1' >
                                ...
                                <div className='patient_details_input_field1_' >
                                    ...
                                    <input disabled value={generalCondition} onChange={(e)=>setgeneralCondition(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>OEDEMA</h4>
                                    <input disabled value={oedema} onChange={(e)=>setoedema(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>ANAEMIA</h4>
                                    <input disabled value={anaemia} onChange={(e)=>setanaemia(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>RESPIRATORY SYSTEM</h4>
                                    <input disabled value={respiratorySystem} onChange={(e)=>setrespiratorySystem(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>CARDIOVASCULAR SYSTEM</h4>
                                    <input disabled value={cardiovascularSystem} onChange={(e)=>setcardiovascularSystem(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>ABDOMEN</h4>
                                    <input disabled value={abdomen} onChange={(e)=>setabdomen(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>SPLEEN</h4>
                                    <input disabled value={spleen} onChange={(e)=>setspleen(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>LIVER</h4>
                                    <input disabled value={liver} onChange={(e)=>setliver(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>PRELIMINARY PELVIC ASSESSMENT</h4>
                                    <input disabled value={preliminary} onChange={(e)=>setpreliminary(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>HEIGHT</h4>
                                    <input disabled value={height} onChange={(e)=>setheight(e.target.value)} />
                                </div>
                                
                                <div className='patient_details_input_field1_in_'>
                                    <div className='patient_details_input_field1_in' >
                                        <h4>FT</h4>
                                        <input disabled value={feet} onChange={(e)=>setfeet(e.target.value)} />
                                    </div>
                                    <div className='patient_details_input_field1_in' >
                                        <h4>INS</h4>
                                        <input disabled value={inches} onChange={(e)=>setinches(e.target.value)} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='patient_details_input_field1'>
                                ...
                                <div className='patient_details_input_field1_' >
                                    <h4>WEIGHT</h4>
                                    <input disabled value={weight} onChange={(e)=>setweight(e.target.value)} />
                                </div>
                                
                                <div className='patient_details_input_field1_in_'>
                                    <div className='patient_details_input_field1_in' >
                                        <h4>ST</h4>
                                        <input disabled value={ST} onChange={(e)=>setST(e.target.value)} />
                                    </div>
                                    <div className='patient_details_input_field1_in' >
                                        <h4>IBS</h4>
                                        <input disabled value={LBS} onChange={(e)=>setLBS(e.target.value)} />
                                    </div>
                                </div>

                                <div className='patient_details_input_field1_' >
                                    <h4>B.P</h4>
                                    <input disabled value={BP} onChange={(e)=>setBP(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>URINE</h4>
                                    ...
                                    <div className='patient_details_input_field1_in_'>
                                        <div className='patient_details_input_field1_in' >
                                            <h4>ALBUMIN</h4>
                                            <input disabled value={albumin} onChange={(e)=>setalbumin(e.target.value)} />
                                        </div>
                                        <div className='patient_details_input_field1_in' >
                                            <h4>SUGAR</h4>
                                            <input disabled value={sugar} onChange={(e)=>setsugar(e.target.value)} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='patient_details_input_field1_' >
                                    ...
                                    <input disabled value={breastNipples} onChange={(e)=>setbreastNipples(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>HB</h4>
                                    <input disabled value={HB} onChange={(e)=>setHB(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>GENOTYPE</h4>
                                    <input disabled value={genotype} onChange={(e)=>setgenotype(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>USS</h4>
                                    <input disabled value={USS} onChange={(e)=>setUSS(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>BLOOD GROUP</h4>
                                    <input disabled value={bloodGroup} onChange={(e)=>setbloodGroup(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>RH</h4>
                                    <input disabled value={RB} onChange={(e)=>setRB(e.target.value)} />
                                </div>
                                <div className='patient_details_input_field1_' >
                                    <h4>CHEST X-RAY</h4>
                                    <input disabled value={chestXray} onChange={(e)=>setchestXray(e.target.value)} />
                                </div>
                            </div>
                        </div>
                        {/* //////////////////////////////////////////////////////////////////////// */}
                        ...
                        <div className='previouse_medicals_textareas' >
                            <div className='patient_details_input_field1' >
                                <div className='patient_details_input_field1_'>
                                    <h4>COMMENTS</h4>
                                    <textarea disabled value={comments} onChange={(e)=>setcomments(e.target.value)} />
                                </div>
                            </div>
                            <div className='patient_details_input_field1' >
                                <div className='patient_details_input_field1_'>
                                    <h4>PELVIC ASSESSMENT AT 36 WEEKS</h4>
                                    <textarea disabled value={pelvicAssessment} onChange={(e)=>setpelvicAssessment(e.target.value)} />
                                </div>
                            </div>
                        </div>
                        {/* //////////////////////////////////////////////////////////////////////// */}
                        ...
                        <table className='custome_table'>
                            ...
                            <tbody>                  
                                ...
                                <tr key={index}>
                                    <td><input disabled type='date' name='date' value={row.date} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='heightOfFundus' value={row.heightOfFundus} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='presentingPartToBrim' value={row.presentingPartToBrim} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='presentationAndPosition' value={row.presentationAndPosition} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='foetalHeart' value={row.foetalHeart} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='urine' value={row.urine} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='BP' value={row.BP} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='weight' value={row.weight} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='HB' value={row.HB} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='oedema' value={row.oedema} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='remark' value={row.remark} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='initialOfExaminer' value={row.initialOfExaminer} onChange={(e) => handleChange1(index, e)} /></td>
                                    <td><input disabled name='Return' value={row.Return} onChange={(e) => handleChange1(index, e)} /></td>
                        ...
                        <div className='previouse_medicals_textareas_NOTE' >
                            <div >
                                ...
                                <textarea disabled value={specialInstruction} onChange={(e)=>setspecialInstruction(e.target.value)} />
                            </div>
                        </div>
                        </>
                    }
            ...
            <div className='dashboard_body'>
                ...
                <div className='patient_details_' >
                    <div className='patient_details_input_field1' >
                        <div className='patient_details_input_field1_'>
                            <h4>PATIENT NAME</h4>
                            <input disabled value={name} onChange={(e)=> setname(e.target.value)} placeholder='Enter Patient Name' />
                        </div>
                        <div className='patient_details_input_field1_'>
                            <h4>ADDRESS</h4>
                            <input disabled value={address} onChange={(e)=> setaddress(e.target.value)} placeholder='Enter Patient Address' />
                        </div>
                        <div className='patient_details_input_field1_'>
                            <h4>RELIGION</h4>
                            <p>{religion}</p>
                        ...
                        <div className='patient_details_input_field1_'>
                            <h4>HOD NO.</h4>
                            <input disabled placeholder='Enter Hod Number' type='number'  value={hop} onChange={(e)=> sethop(e.target.value)}  />
                        </div>
                    </div>
                    ...
                    <div className='patient_details_input_field1' >
                        <div className='patient_details_input_field1_in_'>
                            <div className='patient_details_input_field1_in' >
                                <h4>DATE OF BIRTH</h4>
                                <input disabled  value={dateOfBirth} onChange={(e)=> setdateOfBirth(e.target.value)}  type='date'/>
                            </div>
                            <div className='patient_details_input_field1_in' >
                                <h4>AGE</h4>
                                <input disabled type='number' placeholder='Enter Patient Age'  value={age} onChange={(e)=> setage(e.target.value)}  />
                            </div>
                        </div>
                        <div className='patient_details_input_field1_in_'>
                            <div className='patient_details_input_field1_in1' >
                                <div className='previouse_medicals_checkbox_text'>
                                    ...
                                    <div>
                                        <div>
                                            <p>Male</p>
                                            <input disabled checked={sex === 'male' ? true : false} onChange={(e)=> setsex('male')}  type='checkbox' />
                                        </div>
                                        
                                        <div>
                                            <p>Female</p>
                                            <input disabled checked={sex === 'female' ? true : false} onChange={(e)=> setsex('female')} type='checkbox' />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className='patient_details_input_field1_in' >
                                ...
                                <input disabled type='number' placeholder='Enter Patient Phone Number'  value={phone} onChange={(e)=> setphone(e.target.value)}  />
                            </div>
                        </div>
                        <div className='patient_details_input_field1_in_'>
                            <div className='patient_details_input_field1_in' >
                                <h4>NEXT OF KIN</h4>
                                <input disabled placeholder='Enter Next Kin'  value={nextOfKin} onChange={(e)=> setnextOfKin(e.target.value)}  />
                            </div>
                            <div className='patient_details_input_field1_in' >
                                <h4>NEXT OF KIN PHONE NUMBER</h4>
                                <input disabled type='number' placeholder='Enter Next of kin Phone Number'  value={nextOfKinPhone} onChange={(e)=> setnextOfKinPhone(e.target.value)}  />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='previouse_medicals_textareas_NOTE' >
                    <div >
                        ...
                        <textarea disabled placeholder='Enter Clinical Notes'  value={notes} onChange={(e)=>setnotes(e.target.value)} />
                    </div>
                </div>
