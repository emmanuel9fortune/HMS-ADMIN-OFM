...
const patientdiscount = require('./server/reseption/patientdiscount');
...
async function createServer() {
    ...
    serverApp.use('/patientdiscount', patientdiscount);
    ...
    serverApp.use('/patientStats', patientStats);
    serverApp.use('/editcards', editcards);
...
function createWindow() {
    ...
    const notification = new Notification({
        title: 'HMS ADMIN RUNNING',
        body: 'This is a notification from your admin app!'
    });
